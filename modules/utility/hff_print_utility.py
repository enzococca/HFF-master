...
class Print_utility(QObject):
    ...
    def charge_layer_sqlite(self, sito, area, us):
        ...
        uri.setDataSource('', 'hff_us_view', 'the_geom', gidstr, "ROWID")
        self.layerUS = QgsVectorLayer(uri.uri(), 'hff_us_view', 'spatialite')
        ...
        uri.setDataSource('', 'hff_quote_view', 'the_geom', gidstr, "ROWID")
        self.layerQuote = QgsVectorLayer(uri.uri(), 'hff_quote_view', 'spatialite')
    ...
    def charge_layer_postgis(self, sito, area, us):
        ...
        self.uri.setDataSource("public", "hff_us_view", "the_geom", gidstr, 'gid')
        ...
        self.uri.setDataSource("public", "hff_quote", "the_geom", gidstr, 'gid')
