...
class single_Finds_pdf_sheet(object):
    ...
    def create_sheet(self):
        ...
        ##		test_image = Image("/Users/Windows/hff_PDF_folder/catalogo_immagini/inv120.png")
        ##		test_image.drawHeight = 2*inch*test_image.drawHeight / test_image.drawWidth
        ##		test_image.drawWidth = 2*inch

        # Paragraph('<para autoLeading="off" fontSize=12>This &lt;img/&gt;<img src="/Users/hff/hff_PDF_folder/test_immagini/kelebe.jpg" valign="bottom"/> is aligned<b>bottom</b></para>', styNormal)
        # schema
        cell_schema = [  # 00, 01, 02, 03, 04, 05, 06, 07, 08, 09 rows
            ...
            # ["https://sites.google.com/site/hff/", '01', '02', '03', '04', '05', '06', '07', '08', '09' ] #13 row
