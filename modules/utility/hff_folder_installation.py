...
from .hff_OS_utility import Hff_OS_Utility


class hff_Folder_installation(object):
    HOME = expanduser("~")
    HOME += os.sep + 'HFF'
    ...
    def install_dir(self):
        ...
        home_QUANT_path = '{}{}{}'.format(self.HOME, os.sep, 'hff_Quantificazioni_folder')
    ...
    def installConfigFile(self, path):
        ...
        #added by hff test for logo re-installation
        logo_copy_from_path_rel = os.path.join(os.sep, 'dbfiles', 'logo.png')
        logo_copy_from_path = '{}{}'.format(self.RESOURCES_PATH, logo_copy_from_path_rel)
