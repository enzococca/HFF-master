...
class Hff_pyqgis(QDialog):
    ...
    LAYERS_CONVERT_DIZ = {"anchor_point": "Anchors Point",
                        "hff_anchor_view": "Anchors view",
                        "pottery_point": "Pottery",
                        "hff_pot_view": "Pottery View",
                        "artefact_point": "Artefact",
                        "hff_art_view": "Artefact view",
                        "grab_spot": "Grab spot",
    ...
    def charge_anchor_layers(self, data):
        ...
        if settings.SERVER == 'sqlite':
            ...
            uri.setDataSource('','hff_anchor_view', 'the_geom', gidstr, "ROWIND")
            ...
            uri.setDataSource("public","hff_anchor_view","the_geom",gidstr,"gid")
    ...
    def charge_art_layers(self, data):
        ...
        if settings.SERVER == 'sqlite':
            ...
            uri.setDataSource('','hff_art_view', 'the_geom', gidstr, "ROWIND")
            ...
            uri.setDataSource("public","hff_art_view","the_geom",gidstr,"gid")
    ...
    def charge_pot_layers(self, data):
        ...
        if settings.SERVER == 'sqlite':
            ...
            uri.setDataSource('','hff_pot_view', 'the_geom', gidstr, "ROWIND")
            ...
            uri.setDataSource("public","hff_pot_view","the_geom",gidstr,"gid")
    ...
    def charge_grab_layers(self, data):
        ...
        if settings.SERVER == 'sqlite':
            ...
            uri.setDataSource('','hff_grabspot_view', 'the_geom', gidstr, "ROWIND")
            layerIndividui=QgsVectorLayer(uri.uri(), 'hff_grabspot_view', 'spatialite')
...
##              layerUS.loadNamedStyle(style_path)
            ...
            uri.setDataSource("public","hff_grabspot_view","the_geom",gidstr,"gid")
    ...
    def charge_features_layers(self, data):
        ...
        if settings.SERVER == 'sqlite':
            ...
            uri.setDataSource('','hff_feature_p_view', 'the_geom', gidstr, "ROWIND")
            layerIndividui=QgsVectorLayer(uri.uri(), 'hff_feature_p_view', 'spatialite')
...
##              layerUS.loadNamedStyle(style_path)
            ...
            uri.setDataSource("public","hff_feature_p_view","the_geom",gidstr,"gid")
    ...
    def charge_features_l_layers(self, data):
        ...
        if settings.SERVER == 'sqlite':
            ...
            uri.setDataSource('','hff_feature_l_view', 'the_geom', gidstr, "ROWIND")
            layerIndividui=QgsVectorLayer(uri.uri(), 'hff_feature_p_view', 'spatialite')
...
##              layerUS.loadNamedStyle(style_path)
            ...
            uri.setDataSource("public","hff_feature_l_view","the_geom",gidstr,"gid")
...
##              layerUS.loadNamedStyle(style_path)
            ...
            uri.setDataSource("public","hff_feature_point_view","the_geom",gidstr,"gid")
    ...
    def charge_transect_layers(self, data):
        ...
        if settings.SERVER == 'sqlite':
            ...
            uri.setDataSource('','hff_transect_view', 'the_geom', gidstr, "ROWIND")
            layerIndividui=QgsVectorLayer(uri.uri(), 'hff_transect_view', 'spatialite')
...
##              layerUS.loadNamedStyle(style_path)
            ...
            uri.setDataSource("public","hff_transect_view","the_geom",gidstr,"gid")
    ...
    def loadMapPreview(self, gidstr):
        ...
        if settings.SERVER == 'postgres':
            ...
            #layerUS
            uri.setDataSource("public", "hff_anchor_view", "the_geom", gidstr, "gid")
            layerANC = QgsVectorLayer(uri.uri(), "hff_anchor_view", "postgres")
...
###################### - Site Section - ########################
    ...
    def charge_sites_geometry(self, options, col, val):
        ...
        if settings.SERVER == 'sqlite':
            ...
            #pyunitastratigrafiche e hff_quote nn possono essere aggiornate dinamicamente perche non hanno il campo sito. Da moficare?
