...
from ..modules.db.hff_utility import *
from ..modules.utility.hff_exp_USsheet_pdf import generate_US_pdf
from ..modules.utility.hff_exp_Findssheet_pdf import generate_reperti_pdf
from ..modules.utility.hff_exp_Periodizzazionesheet_pdf import generate_Periodizzazione_pdf
from ..modules.utility.hff_exp_Individui_pdf import generate_pdf
from ..modules.utility.hff_exp_Strutturasheet_pdf import generate_struttura_pdf
from ..modules.utility.hff_exp_Tafonomiasheet_pdf import generate_tafonomia_pdf
from ..modules.utility.hff_exp_Campsheet_pdf import generate_campioni_pdf
...
class hff_pdf_export(QDialog, MAIN_DIALOG_CLASS):
    UTILITY = Utility()
