...
-- Name: hff_campionature; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_campionature (
...
ALTER TABLE public.hff_campionature OWNER TO postgres;

--
-- TOC entry 334 (class 1259 OID 32734)
-- Name: hff_codici_tipologia_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_codici_tipologia_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_codici_tipologia_id_seq OWNER TO postgres;

--
-- TOC entry 335 (class 1259 OID 32736)
-- Name: hff_codici_tipologia; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_codici_tipologia (
    id integer DEFAULT nextval('public.hff_codici_tipologia_id_seq'::regclass) NOT NULL,
...
ALTER TABLE public.hff_codici_tipologia OWNER TO postgres;

--
-- TOC entry 336 (class 1259 OID 32743)
-- Name: hff_individui; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_individui (
    gid integer NOT NULL,
...
ALTER TABLE public.hff_individui OWNER TO postgres;

--
-- TOC entry 337 (class 1259 OID 32749)
-- Name: hff_individui_gid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_individui_gid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_individui_gid_seq OWNER TO postgres;

--
-- TOC entry 5053 (class 0 OID 0)
-- Dependencies: 337
-- Name: hff_individui_gid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.hff_individui_gid_seq OWNED BY public.hff_individui.gid;


--
-- TOC entry 339 (class 1259 OID 32756)
-- Name: hff_inventario_materiali; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_inventario_materiali (
...
ALTER TABLE public.hff_inventario_materiali OWNER TO postgres;
...
-- Name: hff_linee_rif_gid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_linee_rif_gid_seq
    START WITH 6375
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_linee_rif_gid_seq OWNER TO postgres;

SET default_with_oids = false;

--
-- TOC entry 343 (class 1259 OID 32780)
-- Name: hff_linee_rif; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_linee_rif (
    gid integer DEFAULT nextval('public.hff_linee_rif_gid_seq'::regclass) NOT NULL,
...
ALTER TABLE public.hff_linee_rif OWNER TO postgres;

--
-- TOC entry 344 (class 1259 OID 32787)
-- Name: hff_punti_rif_gid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_punti_rif_gid_seq
    START WITH 4928
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_punti_rif_gid_seq OWNER TO postgres;

--
-- TOC entry 345 (class 1259 OID 32789)
-- Name: hff_punti_rif; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_punti_rif (
    gid integer DEFAULT nextval('public.hff_punti_rif_gid_seq'::regclass) NOT NULL,
...
ALTER TABLE public.hff_punti_rif OWNER TO postgres;
...
-- Name: hff_quote_gid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_quote_gid_seq
    START WITH 73833
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_quote_gid_seq OWNER TO postgres;

--
-- TOC entry 350 (class 1259 OID 32816)
-- Name: hff_quote; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_quote (
    gid integer DEFAULT nextval('public.hff_quote_gid_seq'::regclass) NOT NULL,
...
ALTER TABLE public.hff_quote OWNER TO postgres;

--
-- TOC entry 352 (class 1259 OID 32828)
-- Name: hff_ripartizioni_spaziali_gid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_ripartizioni_spaziali_gid_seq
    START WITH 2007
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_ripartizioni_spaziali_gid_seq OWNER TO postgres;

--
-- TOC entry 353 (class 1259 OID 32830)
-- Name: hff_ripartizioni_spaziali; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_ripartizioni_spaziali (
    gid integer DEFAULT nextval('public.hff_ripartizioni_spaziali_gid_seq'::regclass) NOT NULL,
...
ALTER TABLE public.hff_ripartizioni_spaziali OWNER TO postgres;

--
-- TOC entry 354 (class 1259 OID 32837)
-- Name: hff_ripartizioni_temporali; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_ripartizioni_temporali (
...
ALTER TABLE public.hff_ripartizioni_temporali OWNER TO postgres;

--
-- TOC entry 355 (class 1259 OID 32843)
-- Name: hff_ripartizioni_temporali_id_periodo_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_ripartizioni_temporali_id_periodo_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_ripartizioni_temporali_id_periodo_seq OWNER TO postgres;

--
-- TOC entry 5054 (class 0 OID 0)
-- Dependencies: 355
-- Name: hff_ripartizioni_temporali_id_periodo_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.hff_ripartizioni_temporali_id_periodo_seq OWNED BY public.hff_ripartizioni_temporali.id_periodo;


--
-- TOC entry 356 (class 1259 OID 32845)
-- Name: hff_rou_thesaurus; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_rou_thesaurus (
...
ALTER TABLE public.hff_rou_thesaurus OWNER TO postgres;

--
-- TOC entry 357 (class 1259 OID 32851)
-- Name: hff_rou_thesaurus_ID_rou_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."hff_rou_thesaurus_ID_rou_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public."hff_rou_thesaurus_ID_rou_seq" OWNER TO postgres;

--
-- TOC entry 5055 (class 0 OID 0)
-- Dependencies: 357
-- Name: hff_rou_thesaurus_ID_rou_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."hff_rou_thesaurus_ID_rou_seq" OWNED BY public.hff_rou_thesaurus."ID_rou";


--
-- TOC entry 358 (class 1259 OID 32853)
-- Name: hff_sezioni_gid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_sezioni_gid_seq
    START WITH 1223
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_sezioni_gid_seq OWNER TO postgres;

--
-- TOC entry 359 (class 1259 OID 32855)
-- Name: hff_sezioni; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_sezioni (
    gid integer DEFAULT nextval('public.hff_sezioni_gid_seq'::regclass) NOT NULL,
...
ALTER TABLE public.hff_sezioni OWNER TO postgres;
...
CREATE TABLE public.hff_siti (
    gid integer DEFAULT nextval('public.hff_siti_gid_seq'::regclass) NOT NULL,
...
CREATE SEQUENCE public.hff_siti_polygonal_gid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_siti_polygonal_gid_seq OWNER TO postgres;

--
-- TOC entry 361 (class 1259 OID 32864)
-- Name: hff_siti_polygon; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_siti_polygonal (
    gid integer DEFAULT nextval('public.hff_siti_polygonal_gid_seq'::regclass) NOT NULL,
    sito_id character varying(80),
    the_geom public.geometry(Polygon,-1)
);


ALTER TABLE public.hff_siti_polygonal OWNER TO postgres;
...
-- Name: hff_sondaggi_gid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_sondaggi_gid_seq
    START WITH 1262
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_sondaggi_gid_seq OWNER TO postgres;



--
-- TOC entry 363 (class 1259 OID 32873)
-- Name: hff_sondaggi; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_sondaggi (
    gid integer DEFAULT nextval('public.hff_sondaggi_gid_seq'::regclass) NOT NULL,
    sito character varying(80),
...
ALTER TABLE public.hff_sondaggi OWNER TO postgres;

--
-- TOC entry 364 (class 1259 OID 32880)
-- Name: hff_strutture_ipotesi_gid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_strutture_ipotesi_gid_seq
    START WITH 842
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_strutture_ipotesi_gid_seq OWNER TO postgres;

--
-- TOC entry 365 (class 1259 OID 32882)
-- Name: hff_strutture_ipotesi; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_strutture_ipotesi (
    gid integer DEFAULT nextval('public.hff_strutture_ipotesi_gid_seq'::regclass) NOT NULL,
    sito character varying(80),
...
ALTER TABLE public.hff_strutture_ipotesi OWNER TO postgres;
...
-- Name: hff_tafonomia; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_tafonomia (
    gid integer NOT NULL,
    the_geom public.geometry(Point,-1),
...
ALTER TABLE public.hff_tafonomia OWNER TO postgres;

--
-- TOC entry 367 (class 1259 OID 32897)
-- Name: hff_tafonomia_gid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_tafonomia_gid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_tafonomia_gid_seq OWNER TO postgres;

--
-- TOC entry 5056 (class 0 OID 0)
-- Dependencies: 367
-- Name: hff_tafonomia_gid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.hff_tafonomia_gid_seq OWNED BY public.hff_tafonomia.gid;
...
-- Name: hff_thesaurus_sigle_id_thesaurus_sigle_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_thesaurus_sigle_id_thesaurus_sigle_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_thesaurus_sigle_id_thesaurus_sigle_seq OWNER TO postgres;

--
-- TOC entry 5057 (class 0 OID 0)
-- Dependencies: 371
-- Name: hff_thesaurus_sigle_id_thesaurus_sigle_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.hff_thesaurus_sigle_id_thesaurus_sigle_seq OWNED BY public.hff_thesaurus_sigle.id_thesaurus_sigle;


--
-- TOC entry 372 (class 1259 OID 32919)
-- Name: hff_tipologia_sepolture_gid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_tipologia_sepolture_gid_seq
    START WITH 452
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_tipologia_sepolture_gid_seq OWNER TO postgres;

--
-- TOC entry 373 (class 1259 OID 32921)
-- Name: hff_tipologia_sepolture; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_tipologia_sepolture (
    gid integer DEFAULT nextval('public.hff_tipologia_sepolture_gid_seq'::regclass) NOT NULL,
...
ALTER TABLE public.hff_tipologia_sepolture OWNER TO postgres;


--
-- TOC entry 376 (class 1259 OID 32938)
-- Name: hff_us_negative_doc; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hff_us_negative_doc (
    gid integer NOT NULL,
    the_geom public.geometry(LineString,-1),
...
ALTER TABLE public.hff_us_negative_doc OWNER TO postgres;

--
-- TOC entry 377 (class 1259 OID 32944)
-- Name: hff_us_negative_doc_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hff_us_negative_doc_gid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.hff_us_negative_doc_gid_seq OWNER TO postgres;

--
-- TOC entry 5058 (class 0 OID 0)
-- Dependencies: 377
-- Name: hff_us_negative_doc_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.hff_us_negative_doc_gid_seq OWNED BY public.hff_us_negative_doc.gid;
...
--
--------------------------------------------------------------------------------------
---CREATE SEQUENCE public.hff_reperti_gid_seq
---   START WITH 1
 ---   INCREMENT BY 1
 ---   NO MINVALUE
 --   NO MAXVALUE
 --   CACHE 1;
--ALTER TABLE public.hff_reperti_gid_seq OWNER TO postgres;

--ALTER SEQUENCE public.hff_reperti_gid_seq OWNED BY public.hff_reperti_gid_seq.id_rep;

---------------------------------------------------------------

CREATE TABLE public.hff_reperti
(
    gid integer NOT NULL ,
...
ALTER TABLE public.hff_reperti
    OWNER to postgres;

-- Index: sidx_hff_reperti_the_geom

-- DROP INDEX public.sidx_hff_reperti_the_geom;
...
CREATE TABLE hff_documentazione
(
  gid integer NOT NULL,
...
ALTER TABLE hff_documentazione
  OWNER TO postgres;

-- Index: sidx_hff_documentazione_geom

-- DROP INDEX sidx_hff_documentazione_geom;
CREATE SEQUENCE public.hff_documentazione_gid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: hff_individui gid; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_individui ALTER COLUMN gid SET DEFAULT nextval('public.hff_individui_gid_seq'::regclass);


--
-- TOC entry 4543 (class 2604 OID 33170)
-- Name: hff_ripartizioni_temporali id_periodo; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_ripartizioni_temporali ALTER COLUMN id_periodo SET DEFAULT nextval('public.hff_ripartizioni_temporali_id_periodo_seq'::regclass);


--
-- TOC entry 4544 (class 2604 OID 33171)
-- Name: hff_rou_thesaurus ID_rou; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_rou_thesaurus ALTER COLUMN "ID_rou" SET DEFAULT nextval('public."hff_rou_thesaurus_ID_rou_seq"'::regclass);


--
-- TOC entry 4551 (class 2604 OID 33172)
-- Name: hff_tafonomia gid; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_tafonomia ALTER COLUMN gid SET DEFAULT nextval('public.hff_tafonomia_gid_seq'::regclass);


--
-- TOC entry 4554 (class 2604 OID 33173)
-- Name: hff_thesaurus_sigle id_thesaurus_sigle; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_thesaurus_sigle ALTER COLUMN id_thesaurus_sigle SET DEFAULT nextval('public.hff_thesaurus_sigle_id_thesaurus_sigle_seq'::regclass);


--
-- TOC entry 4556 (class 2604 OID 33174)
-- Name: hff_us_negative_doc id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_us_negative_doc ALTER COLUMN gid SET DEFAULT nextval('public.hff_us_negative_doc_gid_seq'::regclass);
...
ALTER TABLE ONLY public.hff_documentazione ALTER COLUMN gid SET DEFAULT nextval('public.hff_documentazione_gid_seq'::regclass);
...
-- Name: riipartizione_territoriale_to_rip_terr id_rel_rip_ter_pk; Type: DEFAULT; Schema: public; Owner: postgres
--
--ALTER TABLE ONLY public.hff_reperti ALTER COLUMN gid SET DEFAULT nextval('public.hff_reperti_gid_seq'::regclass);
...
-- Name: hff_rou_thesaurus ID_rou_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_rou_thesaurus
...
-- Name: hff_codici_tipologia ID_tipologia_unico; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_codici_tipologia
    ADD CONSTRAINT "ID_tipologia_unico" UNIQUE (tipologia_progetto, tipologia_gruppo, tipologia_codice, tipologia_sottocodice);

--
-- TOC entry 4718 (class 2606 OID 41052)
-- Name: hff_documentazione ID_documentazione_unico; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_documentazione
...
-- Name: hff_inventario_materiali id_im_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_inventario_materiali
    ADD CONSTRAINT id_im_pk PRIMARY KEY (idim_pk);


--
-- TOC entry 4745 (class 2606 OID 41108)
-- Name: hff_ripartizioni_temporali id_periodo_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_ripartizioni_temporali
    ADD CONSTRAINT id_periodo_pk PRIMARY KEY (id_periodo);


--
-- TOC entry 4767 (class 2606 OID 41110)
-- Name: hff_thesaurus_sigle id_thesaurus_sigle_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: hff_codici_tipologia id_tip_tombe_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: hff_linee_rif linee_riferimento_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_linee_rif
...
-- Name: hff_ripartizioni_temporali periodo_fase_unico; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: hff_individui hff_individui_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_individui
    ADD CONSTRAINT hff_individui_pkey PRIMARY KEY (gid);


--
-- TOC entry 4740 (class 2606 OID 41144)
-- Name: hff_quote hff_quote_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_quote
    ADD CONSTRAINT hff_quote_pkey PRIMARY KEY (gid);


--
-- TOC entry 4742 (class 2606 OID 41146)
-- Name: hff_ripartizioni_spaziali hff_ripartizioni_spaziali_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_ripartizioni_spaziali
    ADD CONSTRAINT hff_ripartizioni_spaziali_pkey PRIMARY KEY (gid);


--
-- TOC entry 4751 (class 2606 OID 41148)
-- Name: hff_sezioni hff_sezioni_29092009_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_sezioni
    ADD CONSTRAINT hff_sezioni_29092009_pkey PRIMARY KEY (gid);
...
--
-- TOC entry 4753 (class 2606 OID 41150)
-- Name: hff_siti hff_siti__polygon_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_siti_polygonal
    ADD CONSTRAINT hff_siti_polygonal_pkey PRIMARY KEY (gid);	

--
-- TOC entry 4756 (class 2606 OID 41152)
-- Name: hff_sondaggi hff_sondaggi_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_sondaggi
    ADD CONSTRAINT hff_sondaggi_pkey PRIMARY KEY (gid);


--
-- TOC entry 4758 (class 2606 OID 41154)
-- Name: hff_strutture_ipotesi hff_strutture_ipotesi_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_strutture_ipotesi
    ADD CONSTRAINT hff_strutture_ipotesi_pkey PRIMARY KEY (gid);


--
-- TOC entry 4760 (class 2606 OID 41156)
-- Name: hff_tafonomia hff_tafonomia_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_tafonomia
    ADD CONSTRAINT hff_tafonomia_pkey PRIMARY KEY (gid);


--
-- TOC entry 4769 (class 2606 OID 41158)
-- Name: hff_tipologia_sepolture hff_tipologia_sepolture_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_tipologia_sepolture
    ADD CONSTRAINT hff_tipologia_sepolture_pkey PRIMARY KEY (gid);


--
-- TOC entry 4771 (class 2606 OID 41160)
-- Name: hff_us_negative_doc hff_us_negative_doc_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_us_negative_doc
    ADD CONSTRAINT hff_us_negative_doc_pkey PRIMARY KEY (gid);


--
-- TOC entry 4731 (class 2606 OID 41162)
-- Name: hff_punti_rif pyarchnit_punti_riferimento_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hff_punti_rif
...
-- Name: site_table site_table_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
ALTER TABLE ONLY public.hff_reperti
    ADD CONSTRAINT hff_reperti_pkey PRIMARY KEY (gid);
--
...
-- Name: sidx_hff_linee_rif_geom; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX sidx_hff_linee_rif_geom ON public.hff_linee_rif USING gist (the_geom);

CREATE INDEX sidx_hff_reperti_geom ON public.hff_reperti USING gist (the_geom);
--
-- TOC entry 4743 (class 1259 OID 41211)
-- Name: sidx_hff_ripartizioni_spaziali_geom; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX sidx_hff_ripartizioni_spaziali_geom ON public.hff_ripartizioni_spaziali USING gist (the_geom);


--
-- TOC entry 4754 (class 1259 OID 41212)
-- Name: sidx_hff_siti_geom; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX sidx_hff_siti_geom ON public.hff_siti USING gist (the_geom);


--
-- TOC entry 4754 (class 1259 OID 41212)
-- Name: sidx_hff_siti_polygon_geom; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX sidx_hff_siti_polygonal_geom ON public.hff_siti_polygonal USING gist (the_geom);


--
-- TOC entry 4761 (class 1259 OID 41213)
-- Name: sidx_hff_tafonomia_geom; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX sidx_hff_tafonomia_geom ON public.hff_tafonomia USING gist (the_geom);


--
-- TOC entry 4772 (class 1259 OID 41214)
-- Name: sidx_hff_us_negative_doc_geom; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX sidx_hff_us_negative_doc_geom ON public.hff_us_negative_doc USING gist (the_geom);
