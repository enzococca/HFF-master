...
from ..modules.db.hff_db_update import DB_update
...
from ..modules.utility.hff_print_utility import Print_utility
MAIN_DIALOG_CLASS, _ = loadUiType(os.path.join(os.path.dirname(__file__), 'ui', 'hffConfigDialog.ui'))
...
class pyArchInitDialog_Config(QDialog, MAIN_DIALOG_CLASS):
    ...
    def set_db_parameter(self):
        if self.comboBox_Database.currentText() == 'postgres':
            self.lineEdit_DBname.setText("hff")
    ...
    def on_pushButton_import_pressed(self):
        ...
        if conn_str_dict_read["server"] == 'postgres':
            ...
            sqlite_DB_path = '{}{}{}'.format(self.HOME, os.sep,
                                             "HFF_DB_folder")  # "C:\\Users\\Windows\\Dropbox\\hff_san_marco\\" fare modifiche anche in hff_pyqgis
